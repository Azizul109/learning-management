...
class UserTableSeeder extends Seeder
{
  public function run()
  {
    ...
    if (!$is_exist->count()) {
        ...
        $student->email = 'student@udemy.com';
        ...
        $instructor_user->email = 'instructor@udemy.com';
        ...
        $instructor->contact_email = 'instructor@udemy.com';
        $instructor->telephone = '+61 (800) 123-54323';
        $instructor->mobile = '+61 800-1233-8766';
        $instructor->paypal_id = 'instructor@udemy.com';
