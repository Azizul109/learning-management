            ...
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="@if ($course_breadcrumb) {{ $course_breadcrumb }} @else {{ route('course.list') }} @endif">Course
                            List</a></li>
                    ...
                    <div class="cv-course-container">
                        ...
                        <div class="instructor-clist m-0">
                            <div class="col-md-12 p-0 m-0">
                                ...
                                <span>Created by
                                    <b>{{ $course->instructor->first_name . ' ' . $course->instructor->last_name }}</b></span>
                            </div>
                        </div>
                        <div class="row cv-header">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6  col-6">
                                <div class="cv-category-detail cv-rating float-lg-left float-md-right float-sm-right">
                                    ...
                                    <star class="course-rating">
                                        @for ($r = 1; $r <= 5; $r++)
                                            <span
                                                class="fa fa-star {{ $r <= $course->ratings->avg('rating') ? 'checked-vpage' : '' }}"></span>
                                        @endfor
                                    </star>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                                <div class="cv-category-detail cv-enroll float-lg-right float-md-right float-sm-right">
                                    <a href="{{ route('course.checkout', $course->course_slug) }}"
                                        class="btn btn-ulearn-cview mt-1">ENROLL COURSE</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="course-image mt-2">
                            <img
                                src="@if (Storage::exists($course->course_image)) {{ asset('public/storage/' . $course->course_image) }}@else{{ asset('backend/assets/images/course_detail.jpg') }} @endif">
                        </div>
                                ...
                                @foreach ($curriculum_sections as $curriculum_section => $curriculum_lectures)
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-header" id="headingOne-{{ $section_id }}">
                                            <h5 class="mb-0">
                                                <button class="btn btn-acc-head" type="button" data-toggle="collapse"
                                                    data-target="#collapseOne-{{ $section_id }}" aria-expanded="true"
                                                    aria-controls="collapseOne-{{ $section_id }}">
                                                    <i
                                                        class="fas @if ($loop->first) fa-minus @else fa-plus @endif accordian-icon mr-2"></i><span>{{ $section_name }}</span>
                                                </button>
                                            </h5>
                                        </div>

                                        <div id="collapseOne-{{ $section_id }}"
                                            class="collapse @if ($loop->first) show @endif"
                                            aria-labelledby="headingOne-{{ $section_id }}"
                                        ...
                                        <div class="review-row row mx-0">
                                            ...
                                            <div class="col-9">
                                                <star class="course-rating">
                                                    @for ($r = 1; $r <= 5; $r++)
                                                        <span
                                                            class="fa fa-star {{ $r <= $rating->rating ? 'checked' : '' }}"></span>
                                                    @endfor
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                    <section class="course-feature">
                        ...
                        <ul class="list-unstyled cf-pricing-li">
                            ...
                            <li><i class="far fa-clock"></i>Duration: {{ $course->duration ? $course->duration : '-' }}
                            </li>
                        ...
                        <section class="course_preview_video mt-3">
                            <div class="aligncenter overlay">
                                ...
                                <video controls id="myVideo" style="display:none;">
                                    <source src="{{ asset('public/storage/' . $file_name) }}" type="video/mp4">
                                    Your browser doesn't support HTML5 video tag.
                                </video>
                                <img src="@if (Storage::exists($file_image_name)) {{ asset('public/storage/' . $file_image_name) }}@else{{ asset('backend/assets/images/course_detail.jpg') }} @endif"
