    ...
    <div class="page-content">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <form method="POST" action="{{ route('instructor.course.image.save') }}" id="courseForm"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <label class="cabinet center-block">
                                <figure class="course-image-container">
                                    ...
                                    <img src="@if (Storage::exists($course->course_image)) {{ asset('public/storage/' . $course->course_image) }}@else{{ asset('backend/assets/images/course_detail.jpg') }} @endif"
                                    ...
                                    <div class="input-group input-group-file" data-plugin="inputGroupFile">
                                        ...
                                        <span class="input-group-btn">
                                            <span class="btn btn-success btn-file">
                                                ...
                                                <input type="file" class="item-img file center-block" name="course_image"
                                                    id="course_image" />
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            //image crop start
            $(".gambar").attr("src",
                @if (Storage::exists($course->course_image))
