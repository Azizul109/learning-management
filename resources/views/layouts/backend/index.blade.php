...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/vendor/bootstrap-tagsinput/bootstrap-tagsinput.min599c.css?v4.0.2') }}">
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/vendor/datatables.net-bs4/dataTables.bootstrap4.min599c.css?v4.0.2') }}">
    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center">
                ...
                <span class="navbar-brand-text hidden-xs-down"> UDEMY</span>
            </div>
